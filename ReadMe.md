...
SQLite3でSQL実行時、毎回DBを開閉するデコレータ。クラスでやろうとしたが意味不明になった。

# 前回

* s[Python.Sqlite3.decorator.20180228103240](https://github.com/ytyaru0/Python.Sqlite3.decorator.20180228103240)
